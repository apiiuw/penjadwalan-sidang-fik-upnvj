...
<div class="w-full h-full flex flex-col justify-center">
    ...
    <div class="my-20">
        ...
        <form id="form-nilai-sidang" action="{{ route('penguji.nilai-sidang.store', ['id' => $mahasiswa->id]) }}" method="POST">
            @csrf
            <div class="shadow-lg rounded-sm max-w-3xl mx-auto p-6 bg-white space-y-6 text-sm text-center">
                ...
                <!-- Ketua Penguji -->
                <div class="{{ $peranPenguji !== 'penguji_1' ? 'hidden' : '' }}">
                ...
                <!-- Penguji 2 - Komperhensif -->
                <div class="{{ $peranPenguji !== 'penguji_2' ? 'hidden' : '' }}">
