...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <form class="max-w-4xl mx-auto" method="GET" action="{{ route('penguji.nilai-sidang-mahasiswa') }}">
                    ...
                    @forelse ($dataSidang as $index => $sidang)
                        <tr class="bg-white border-b hover:bg-blue-100 text-gray-800 text-base">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ url('/penguji/nilai-sidang-mahasiswa/input-nilai/'.$sidang->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Input Nilai Sidang</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
