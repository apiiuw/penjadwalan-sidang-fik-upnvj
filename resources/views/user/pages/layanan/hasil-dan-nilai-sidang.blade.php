...
<div class="w-full h-full flex flex-col justify-center">
    ...
    <div class="my-20">
        <h1 class=" uppercase w-full text-center text-3xl font-bold text-blue-700 mb-8">Hasil dan Nilai Sidang</h1>
        ...
        <table class="w-full border border-gray-300 text-left">
          ...
          <tbody>
            <tr>
              ...
              <td class="border text-center nilai-ketua" data-bobot="0.2">{{ $nilaiSidang->ketua_nilai_presentasi ?? '-' }}</td>
              <td class="border text-center">20%</td>
              <td class="border text-center nilai-bobot-ketua">00.00</td>
            </tr>
            <tr>
              <td class="border px-2 py-1 text-center">2</td>
              <td class="border px-2 py-1">Penguasaan Materi</td>
              <td class="border text-center nilai-ketua" data-bobot="0.3">{{ $nilaiSidang->ketua_nilai_penguasaan_materi ?? '-' }}</td>
            ...
            <tr>
              ...
              <td class="border text-center nilai-ketua" data-bobot="0.15">{{ $nilaiSidang->ketua_nilai_penulisan ?? '-' }}</td>
            ...
            <tr>
              ...
              <td class="border text-center nilai-ketua" data-bobot="0.35">{{ $nilaiSidang->ketua_nilai_hasil_akhir ?? '-' }}</td>
              <td class="border text-center">35%</td>
              <td class="border text-center nilai-bobot-ketua">00.00</td>
            </tr>
            <tr class="font-semibold bg-gray-50">
              <td colspan="4" class="border px-2 py-1 text-right">NILAI AKHIR</td>
              <td class="border text-center" id="total-nilai-ketua">00.00</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="w-full border border-gray-300 text-left mb-4">
          ...
          <tbody>
            <tr>
              <td class="border px-2 py-1 text-center">1</td>
              <td class="border px-2 py-1">Presentasi</td>
              <td class="border text-center nilai-penguji1-sidang" data-bobot="0.2">{{ $nilaiSidang->penguji1_nilai_sidang_presentasi ?? '-' }}</td>
              <td class="border text-center">20%</td>
            ...
            <tr>
              <td class="border px-2 py-1 text-center">2</td>
              <td class="border px-2 py-1">Penguasaan Materi</td>
              <td class="border text-center nilai-penguji1-sidang" data-bobot="0.3">{{ $nilaiSidang->penguji1_nilai_sidang_penguasaan_materi ?? '-' }}</td>
              <td class="border text-center">30%</td>
              <td class="border text-center nilai-bobot-penguji1-sidang">00.00</td>
            </tr>
            <tr>
              <td class="border px-2 py-1 text-center">3</td>
              <td class="border px-2 py-1">Penulisan</td>
              <td class="border text-center nilai-penguji1-sidang" data-bobot="0.15">{{ $nilaiSidang->penguji1_nilai_sidang_penulisan ?? '-' }}</td>
              <td class="border text-center">15%</td>
              <td class="border text-center nilai-bobot-penguji1-sidang">00.00</td>
            </tr>
            <tr>
              <td class="border px-2 py-1 text-center">4</td>
              <td class="border px-2 py-1">Hasil Akhir</td>
              <td class="border text-center nilai-penguji1-sidang" data-bobot="0.35">{{ $nilaiSidang->penguji1_nilai_sidang_hasil_akhir ?? '-' }}</td>
              <td class="border text-center">35%</td>
              <td class="border text-center nilai-bobot-penguji1-sidang">00.00</td>
            </tr>
            <tr class="font-semibold bg-gray-50">
        ...
        <table class="w-full border border-gray-300 text-left">
          ...
          <tbody>
            <tr>
              ...
              <td class="border text-center nilai-penguji1-bimbingan" data-bobot="0.4">{{ $nilaiSidang->penguji1_nilai_bimbingan_ketepatan ?? '-' }}</td>
            ...
            <tr>
              ...
              <td class="border text-center nilai-penguji1-bimbingan" data-bobot="0.3">{{ $nilaiSidang->penguji1_nilai_bimbingan_ketekunan_usaha ?? '-' }}</td>
              <td class="border text-center">30%</td>
              <td class="border text-center nilai-bobot-penguji1-bimbingan">00.00</td>
            </tr>
            <tr>
              ...
              <td class="border text-center nilai-penguji1-bimbingan" data-bobot="0.3">{{ $nilaiSidang->penguji1_nilai_bimbingan_tingkah_laku ?? '-' }}</td>
              <td class="border text-center">30%</td>
              <td class="border text-center nilai-bobot-penguji1-bimbingan">00.00</td>
            </tr>
            <tr class="font-semibold bg-gray-50">
        ...
        <table class="w-full border border-gray-300 text-left">
          ...
          <tbody>
            <tr>
              ...
              <td class="border text-center nilai-penguji2-sidang" data-bobot="0.3">{{ $nilaiSidang->penguji2_nilai_sidang_cara_menjawab ?? '-' }}</td>
              <td class="border text-center">30%</td>
            ...
            <tr>
              ...
              <td class="border text-center nilai-penguji2-sidang" data-bobot="0.3">{{ $nilaiSidang->penguji2_nilai_sidang_kecepatan_menjawab ?? '-' }}</td>
              <td class="border text-center">30%</td>
              <td class="border text-center nilai-bobot-penguji2-sidang">00.00</td>
            </tr>
            <tr>
              ...
              <td class="border text-center nilai-penguji2-sidang" data-bobot="0.4">{{ $nilaiSidang->penguji2_nilai_sidang_ketepatan_menjawab ?? '-' }}</td>
              <td class="border text-center">40%</td>
              <td class="border text-center nilai-bobot-penguji2-sidang">00.00</td>
            </tr>
            <tr class="font-semibold bg-gray-50">
...
<script>
  function kalkulasiNilai(prefix) {
      const nilaiDivs = document.querySelectorAll(`.nilai-${prefix}`);
      const nilaiBobotCells = document.querySelectorAll(`.nilai-bobot-${prefix}`);
      let total = 0;

      nilaiDivs.forEach((div, index) => {
          const bobot = parseFloat(div.dataset.bobot) || 0;
          const nilai = parseFloat(div.textContent) || 0;
          const hasil = nilai * bobot;
          if (nilaiBobotCells[index]) {
  ...
  // Panggil fungsi sekali saat awal (kalau isinya sudah ada)
