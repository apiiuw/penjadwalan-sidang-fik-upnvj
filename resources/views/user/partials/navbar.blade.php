<nav class="fixed top-0 left-0 w-full z-50 bg-gradient-to-b from-black to-blue-500">
      ...
      <div class="z-50 hidden list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm" id="user-dropdown">
        <div class="px-4 py-3">
          @auth
              ...
              <span class="block text-sm text-yellow-600">{{ Auth::user()->role }}</span>
          @endauth
        </div>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
      <li>
        <a href="/" class="block text-lg py-2 px-3 text-white rounded-sm hover:bg-black md:hover:bg-transparent md:hover:text-gray-300 md:p-0">Home</a>
      </li>
      <li>
