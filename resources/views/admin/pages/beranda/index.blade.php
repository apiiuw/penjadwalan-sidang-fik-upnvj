...
<div class="w-full h-full flex flex-col justify-center">
    ...
    <div class="space-y-10 my-20">
        ...
        <div class="flex justify-center gap-x-10">
            ...
            {{-- Card 3 --}}
            {{-- <a href="/admin/informasi-sidang" class=" w-96 bg-gradient-to-b from-black/90 to-blue-500 border-blue-700 rounded-lg shadow-sm transition duration-300 ease-in-out hover:scale-105">
