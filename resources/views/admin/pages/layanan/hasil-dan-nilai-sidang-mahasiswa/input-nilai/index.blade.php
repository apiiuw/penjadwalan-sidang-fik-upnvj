...
<div class="w-full h-full flex flex-col justify-center">
    ...
    <div class="my-20">
        ...
        <form id="form-nilai-sidang" action="{{ route('nilai-sidang.store', ['id' => $mahasiswa->id]) }}" method="POST">
            @csrf
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border text-center">
                                    <input type="number" name="ketua_nilai_presentasi" placeholder="{{ $mahasiswa->ketua_nilai_presentasi }}" class=" placeholder:text-gray-500 nilai-ketua w-14 text-center no-spinner" data-bobot="0.2">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="border text-center">
                                    <input type="number" name="ketua_nilai_penguasaan_materi" placeholder="{{ $mahasiswa->ketua_nilai_penguasaan_materi }}" class="placeholder:text-gray-500 nilai-ketua w-14 text-center no-spinner" data-bobot="0.3">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="border text-center">
                                    <input type="number" name="ketua_nilai_penulisan" placeholder="{{ $mahasiswa->ketua_nilai_penulisan }}" class="placeholder:text-gray-500 nilai-ketua w-14 text-center no-spinner" data-bobot="0.15">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="border text-center">
                                    <input type="number" name="ketua_nilai_hasil_akhir" placeholder="{{ $mahasiswa->ketua_nilai_hasil_akhir }}" class="placeholder:text-gray-500 nilai-ketua w-14 text-center no-spinner" data-bobot="0.35">
                                </td>
                ...
                <div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border px-2 py-1">Presentasi</td>
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_sidang_presentasi" placeholder="{{ $mahasiswa->penguji1_nilai_sidang_presentasi }}" class=" placeholder:text-gray-500 nilai-penguji1-sidang w-14 text-center no-spinner" data-bobot="0.2">
                            </td>
                            <td class="border text-center">20%</td>
                        ...
                        <tr>
                            ...
                            <td class="border px-2 py-1">Penguasaan Materi</td>
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_sidang_penguasaan_materi" placeholder="{{ $mahasiswa->penguji1_nilai_sidang_penguasaan_materi }}" class=" placeholder:text-gray-500 nilai-penguji1-sidang w-14 text-center no-spinner" data-bobot="0.3">
                            </td>
                            <td class="border text-center">30%</td>
                            <td class="border text-center nilai-bobot-penguji1-sidang">00.00</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border px-2 py-1">Penulisan</td>
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_sidang_penulisan" placeholder="{{ $mahasiswa->penguji1_nilai_sidang_penguasaan_materi }}" class=" placeholder:text-gray-500 nilai-penguji1-sidang w-14 text-center no-spinner" data-bobot="0.15">
                            </td>
                            <td class="border text-center">15%</td>
                            <td class="border text-center nilai-bobot-penguji1-sidang">00.00</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border px-2 py-1">Hasil Akhir</td>
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_sidang_hasil_akhir" placeholder="{{ $mahasiswa->penguji1_nilai_sidang_hasil_akhir }}" class=" placeholder:text-gray-500 nilai-penguji1-sidang w-14 text-center no-spinner" data-bobot="0.35">
                            </td>
                            <td class="border text-center">35%</td>
                            <td class="border text-center nilai-bobot-penguji1-sidang">00.00</td>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_bimbingan_ketepatan" placeholder="{{ $mahasiswa->penguji1_nilai_bimbingan_ketepatan }}" class=" placeholder:text-gray-500 nilai-penguji1-bimbingan w-14 text-center no-spinner" data-bobot="0.4">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_bimbingan_ketekunan_usaha" placeholder="{{ $mahasiswa->penguji1_nilai_bimbingan_ketekunan_usaha }}" class=" placeholder:text-gray-500 nilai-penguji1-bimbingan w-14 text-center no-spinner" data-bobot="0.3">
                            </td>
                            <td class="border text-center">30%</td>
                            <td class="border text-center nilai-bobot-penguji1-bimbingan">00.00</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border text-center">
                                <input type="number" name="penguji1_nilai_bimbingan_tingkah_laku" placeholder="{{ $mahasiswa->penguji1_nilai_bimbingan_tingkah_laku }}" class="placeholder:text-gray-500 nilai-penguji1-bimbingan w-14 text-center no-spinner" data-bobot="0.3">
                            </td>
                            <td class="border text-center">30%</td>
                            <td class="border text-center nilai-bobot-penguji1-bimbingan">00.00</td>
                        </tr>
                ...
                <div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border text-center">
                                <input type="number" name="penguji2_nilai_sidang_cara_menjawab" placeholder="{{ $mahasiswa->penguji2_nilai_sidang_cara_menjawab }}" class=" placeholder:text-gray-500 nilai-penguji2-sidang w-14 text-center no-spinner" data-bobot="0.3">
                            </td>
                            <td class="border text-center">30%</td>
                        ...
                        <tr>
                            ...
                            <td class="border text-center">
                                <input type="number" name="penguji2_nilai_sidang_kecepatan_menjawab" placeholder="{{ $mahasiswa->penguji2_nilai_sidang_kecepatan_menjawab }}" class=" placeholder:text-gray-500 nilai-penguji2-sidang w-14 text-center no-spinner" data-bobot="0.3">
                            </td>
                            <td class="border text-center">30%</td>
                            <td class="border text-center nilai-bobot-penguji2-sidang">00.00</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border text-center">
                                <input type="number" name="penguji2_nilai_sidang_ketepatan_menjawab" placeholder="{{ $mahasiswa->penguji2_nilai_sidang_ketepatan_menjawab }}" class=" placeholder:text-gray-500 nilai-penguji2-sidang w-14 text-center no-spinner" data-bobot="0.4">
                            </td>
                            <td class="border text-center">40%</td>
                            <td class="border text-center nilai-bobot-penguji2-sidang">00.00</td>
                        </tr>
