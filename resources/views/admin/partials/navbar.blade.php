<nav class="fixed top-0 left-0 w-full z-50 bg-gradient-to-b from-black to-blue-500">
  ...
  <div class="flex items-center md:order-2 gap-x-1 md:gap-x-3 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <div class="z-50 hidden list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm" id="user-dropdown">
        <div class="px-4 py-3">
          <span class="block text-sm text-gray-900">Didit Surabaya</span>
          <span class="block text-sm text-gray-900">2210501000</span>
          <span class="block text-sm text-gray-900">Fakultas Ilmu Komputer</span>
          <span class="block text-sm  text-gray-600 truncate">didit.surabaya@gmail.com</span>
          <span class="block text-sm text-green-600">Admin</span>
        </div>
